library(parallel)
probinfe <- c(0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5)
maxepi <- c()
for(o in probinfe){
l <- 1.5
n <- 50
...
maxepi <- c(maxepi, max(epidemia))
}
}
maxepi5 <- c(maxepi[1:15])
maxepi10 <- c(maxepi[16:30])
maxepi15 <- c(maxepi[31:45])
maxepi20 <- c(maxepi[46:60])
maxepi25 <- c(maxepi[61:75])
maxepi30 <- c(maxepi[76:90])
maxepi35 <- c(maxepi[91:105])
maxepi40 <- c(maxepi[106:120])
maxepi45 <- c(maxepi[121:135])
maxepi50 <- c(maxepi[136:150])


datosbox <- data.frame(maxepi5, maxepi10, maxepi15, maxepi20,maxepi25, maxepi30, maxepi35,maxepi40,maxepi45, maxepi50)
png("R2P6.png")
colnames(datosbox)<- c(5,10,15,20,25,30,35,40,45,50)
boxplot(datosbox, use.cols =FALSE, xlab= "probabilidad de infectados", ylab = "cantidad de infectados", cex.lab = 1.5, cex.axis = 1.5)
graphics.off()