...
for (tiempo in 1:tmax) {
  ...
  clusterExport(cluster1, "recuperado")
  clusterExport(cluster1, "n")
  clusterExport(cluster1, "agentes")
  clusterExport(cluster1, "quiencontagio")
  clusterExport(cluster1, "pr")
  vecrecuperados <- parSapply(cluster1, 1:n, recuperado)
  ...
  clusterExport(cluster2, "movimientosx")
  clusterExport(cluster2, "n")
  clusterExport(cluster2, "agentes")
  clusterExport(cluster2, "l")
  nvosx <- parSapply(cluster2, 1:n, movimientosx)
  stopCluster(cluster2)
  
  #movimientos y
  cluster3 <- makeCluster(detectCores()-1)
  clusterExport(cluster3, "movimientosy")
  clusterExport(cluster3, "n")
  clusterExport(cluster3, "agentes")
  clusterExport(cluster3, "l")
  nvosy <- parSapply(cluster3, 1:n, movimientosy)
  ...
  salida <- paste("R1P6_t", tl, ".png", sep="")
